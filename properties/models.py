...
class Property(models.Model):
    ...
    property_type = models.CharField(choices=PROPERTY_TYPE_SOURCES, max_length=100, null=True, blank=True)
    ...
    garage = models.CharField(choices=GARAGE_SOURCES, max_length=100, null=True, blank=True)
    vacancy_rate = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name="Vacancy Rate %")
    ...
    other_income = models.DecimalField(max_digits=12, decimal_places=2, blank=True, default=0.00)
    bodycorp_fee = models.DecimalField(max_digits=6, decimal_places=2, blank=True, default=0.00)
    management_fee = models.DecimalField(max_digits=6, decimal_places=2, blank=True, default=0.00, verbose_name="Management fee %")
    insurance = models.DecimalField(max_digits=12, decimal_places=2, blank=True, default=0.00)
    maintenance  = models.DecimalField(max_digits=12, decimal_places=2, blank=True, default=0.00)
