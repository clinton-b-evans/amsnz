...
urlpatterns = [
    ...
    path('commodities/transaction/add/<str:pk>',add_transaction, name='transaction-add'),
    path('commodities/<pk>/',commodity_detail_view, name='detail'),
    path('commodities/<str:pk>/edit',update_commodity, name='update'),
    path('commodities/transaction/<str:pk>/edit',update_transaction, name='update-transaction'),
    path('commodities/<str:pk>/delete',delete_commodity, name='delete'),
    path('commodities/transaction/<str:pk>/delete',delete_transaction, name='delete-transaction'),
