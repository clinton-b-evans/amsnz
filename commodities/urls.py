...
from .views import (
    ...
    get_commodities, addTransaction, edit_transaction, edit_sufi_transaction, add_sufi_transaction,
...
urlpatterns = [
    ...
    path('commodities/delete-transaction/',  delete_transaction, name='delete-transaction'),
    ...
    path('commodities/add_commodity', add_commodity, name="add-commodity"),
    path(
