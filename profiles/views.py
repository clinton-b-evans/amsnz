...
def property_detail_view(request, **kwargs):
    ...
    operating_expenses = obj.insurance + obj.management_fee + obj.maintenance + obj.rates
...
def property_summary_view(request):
    ...
    total_operating_expenses = total_insurance + total_management_fee + total_maintenance + total_rates
