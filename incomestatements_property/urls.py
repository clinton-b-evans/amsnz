...
urlpatterns = [
    path('propertyincomestatements/', incomestatement_property_list_view, name='property-incomestatement-list'),
    path('propertyincomestatements/add', add_property_incomestatements, name='add_property_incomestatements'),
    path('propertyincomestatements/add_category', add_property_category, name='add_property_category'),
    path('propertyincomestatements/<str:pk>/edit',update_property_incomestatements, name='update_property_category'),
    path('propertyincomestatements/<str:pk>/delete',delete_property_incomestatement, name='delete_property_incomestatement'),
    path('propertyincomestatements/yeartodate/<str:year>/',year_to_date, name='year-to-date'),
